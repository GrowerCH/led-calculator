const SPECS_LIST = [new Spec("Modul", "", ""),
    ...
    new Spec("Preis", "€", "Zeigt den günstigsten Preis (inkl. Mwst.) für die Module (Zuletzt aktualisiert am 29. Januar). Auf den Modulnamen klicken, um aktuellen Bestpreis anzuzeigen."),
