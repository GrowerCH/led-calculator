const SPECS_LIST = [new Spec("Modul", "", ""),
    ...
    new Spec("Preis", "€", "Zeigt den günstigsten Preis (exkl. Mwst.) für die Module (Zuletzt aktualisiert am 4. Dezember). Auf den Modulnamen klicken, um aktuellen Bestpreis anzuzeigen."),
    new Spec("Preis/Diode", "€", "Zeigt den Preis einer einzelnen LED Diode."),
    new Spec("Stromk./Grow", "€", "Zeigt die Stromkosten (bei 30 Cent kWh Strompreis) für einen Grow (Vegetation -> 12h, Blüte -> 18h)."),
