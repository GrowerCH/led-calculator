const SPECS_LIST = [new Spec("Modul", "", ""),
    ...
    new Spec("Preis", "€", "Zeigt den günstigsten Preis (inkl. Mwst.) für die Module (Zuletzt aktualisiert am 18. August 2020). Auf den Modulnamen klicken, um aktuellen Bestpreis anzuzeigen."),
